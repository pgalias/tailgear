...
export const InSliderNormal: FC = () => (
  <section className="bg-white dark:bg-coolGray-800 rounded-lg p-8 shadow-lg">
    ...
    <article className="flex flex-wrap">
      <div className="w-full sm:w-2/5 rounded-lg overflow-hidden relative">
        <button type="button" className="absolute bottom-0 left-0 p-3 text-2xl">
          <FontAwesomeIcon
      ...
      <div className="w-full sm:w-3/5 sm:p-8 flex flex-col justify-center">
        ...
        <div className="mb-4">
          ...
          <p className="m-0 text-blueGray-400 text-sm">{EMPLOYEES[3].title}</p>
        </div>
        <div className="mb-4">
          <h4 className="m-0 text-blue-900 dark:text-blue-200 font-bold">
            Description
        ...
        <div className="sm:mt-4">
          ...
          >
            ...
            <FontAwesomeIcon icon={faTwitterSquare} className="text-blue-400" />
          </a>
          <a
